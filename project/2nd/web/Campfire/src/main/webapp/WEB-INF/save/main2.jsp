...
<style>
/*
		해당 상자 가운데 정렬 시도중 : 들어갈 글 내용 정한 후에 수정해야 할 듯
		#out {
			width: 100%;
			text-align: center;
			padding: 20px;
...
<body>
	...
	<nav
		...
		<div class="container">
			<a class="navbar-brand" href="index">CAMPFIRE KOREA</a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<!--추가  -->
					<li class="nav-item"><a href="#" class="nav-link" id="loginA"></a></li>
				</ul>
			</div>
		</div>
	</nav>
		...
		<div class="container">
			<div
				...
				<div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
					<div class="text text-center" id="in">
						<h1 class="mb-4">
							게임 플레이 영상<br>
						</h1>
						<p style="font-size: 18px;">PLAY NOW ▽</p>
									...
									<div class="form-group">
										<div class="form-field">
											<input type="text" class="form-control"
												placeholder="CLICK and PLAY NOW!">
											<button>
		...
		<div class="container">
			<div class="row">
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text text-border d-flex align-items-center">
							<strong class="number" data-number="305">0</strong> <span>Total
								<br>회원 수
							</span>
						</div>
					</div>
				...
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text text-border d-flex align-items-center">
							<strong class="number" data-number="209">0</strong> <span>Total
								<br>플레이 수
							</span>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-3 ftco-animate">
					<div class="agent">
						...
						<div class="desc">
							<h3>
								<a href="properties">James Stallon</a>
							</h3>
							<p class="h-info">
								<span class="location">Listing</span> <span class="details">&mdash;
									10 Properties</span>
							</p>
						</div>
					</div>
				...
				<div class="col-md-3 ftco-animate">
					<div class="agent">
						...
						<div class="desc">
							...
							<p class="h-info">
								<span class="position">Listing</span> <span class="details">&mdash;
									10 Properties</span>
							</p>
						</div>
					</div>
				...
				<div class="col-md-3 d-flex ftco-animate">
					<div class="blog-entry justify-content-end">
						<div class="text">
							...
							<a href="blog-single" class="block-20 img"
