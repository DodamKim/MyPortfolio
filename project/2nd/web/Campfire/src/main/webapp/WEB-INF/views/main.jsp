...
<body>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="goto-game">
				<div id="btn-goto-game" class="btn-goto-game">Play Now</div>
			</div>
		</div>
		<div class="mouse">
		...
		<div class="container">
			<div class="row no-gutters">
				<div
					...
					style="background-image: url(images/main-game-img.png);"></div>
				<div class="col-md-6 wrap-about py-md-5 ftco-animate">
					<div id="intro-game" class="heading-section p-md-5">
						<h2 class="mb-4">The Adventures of Rabbits!</h2>
						<p>The Adventures of Rabbits.</p>
						<p>우리의 연약한 토끼가 모험을 떠나요.</p>
						<p>나무 장작을 모아 횃불을 만들 수 있어요.</p>
						<p>누구보다 빠르게 토끼의 모험을 끝내주세요!</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text text-border d-flex align-items-center">
							<strong class="number" data-number="1188">0</strong> <span>Total<br>회원
								수
							</span>
						</div>
					</div>
				...
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text text-border d-flex align-items-center">
							<strong class="number" data-number="63421">0</strong> <span>Total<br>방문자
								수
							</span>
						</div>
					</div>
				...
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text text-border d-flex align-items-center">
							<strong class="number" data-number="40065">0</strong> <span>Total<br>플레이
								수
							</span>
						</div>
					</div>
				...
				<div
					...
					<div class="block-18 py-4 mb-4">
						<div class="text d-flex align-items-center">
							<strong class="number" data-number="9142">0</strong> <span>Average<br>평균 클리어
								시간
							</span>
						</div>
					</div>
