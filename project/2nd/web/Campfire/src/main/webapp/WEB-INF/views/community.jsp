...
<body>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="ppp1">
				<div id="ppp2" class="btn-head-play">Community</div>
			</div>
		</div>
		<div class="mouse">
				...
				<div class="col-md-12">
					<div class="property-details">
						<div class="text text-center">
							<span class="subheading">캠프파이어</span>
							<h2>커뮤니티</h2>
						</div>
					</div>
				</div>
					...
					<div class="bd-example bd-example-tabs">
						<div class="d-flex justify-content-center">
							<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
								...
								<li class="nav-item"><a class="nav-link active"
									...
									aria-controls="pills-description" aria-expanded="true">공지사항</a>
								</li>
								<li class="nav-item"><a class="nav-link"
									id="pills-manufacturer-tab" data-toggle="pill"
									href="#pills-manufacturer" role="tab"
									aria-controls="pills-manufacturer" aria-expanded="true">유저팁</a></li>
								<li class="nav-item"><a class="nav-link"
									id="pills-review-tab" data-toggle="pill" href="#pills-review"
									role="tab" aria-controls="pills-review" aria-expanded="true">자유게시판</a>
								</li>
							</ul>
						</div>
						...
						<div class="tab-content" id="pills-tabContent">
							<div class="tab-pane fade show active" id="pills-description"
								...
								<div class="row">
									<iframe id='iframe-notice' class="iframe-board" 
										src="http://localhost:8088/notice"></iframe>
								</div>
							</div>
							...
							<div class="tab-pane fade" id="pills-manufacturer"
								...
								<div class="row">
									<iframe id='iframe-tip' class="iframe-board" 
										src="http://localhost:52273/community-tip.html"></iframe>
								</div>
							</div>
							...
							<div class="tab-pane fade" id="pills-review" role="tabpanel"
								...
								<div class="row">
									<iframe id='iframe-board' class="iframe-board"  src="http://localhost:8088/board"></iframe>
								</div>
							</div>
						</div>
