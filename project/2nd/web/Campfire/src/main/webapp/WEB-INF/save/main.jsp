...
<body>
	...
	<div class="hero-wrap ftco-degree-bg" style="background-image: url('images/bg_1.jpg');" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row no-gutters slider-text justify-content-center align-items-center" id="out">
				<div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
					<div class="text text-center" id="in">
						<h1 class="mb-4">게임 플레이 영상<br></h1>
								...
								<div class="col-lg-10 align-items-end">
									<div class="form-group">
										<div class="form-field">
											<input type="text" class="form-control" placeholder="CLICK and PLAY NOW!">
			...
			<div class="row">
				<div class="col-md-3 ftco-animate">
					<div class="agent">
						...
						<div class="desc">
							<h3><a href="properties">James Stallon</a></h3>
