...
<script>
    $(function(){
        $("#btnInsert").click(function(){
            ...
            $.post({ url:"/insertNotice", data:data, success:function(r){
                if( r == 2) {
                    alert('글이 등록되었습니다.')
	...
	<div id="contentarea">
		...
		<div id="content-form" class="content-form">
			...
			<form action="insert" id="F" method="POST"
				...
				<div class="content-form-div">
					<input type="button" id="btnInsert" value="등록" class="btn btn-sm">
