...
<body>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="ppp1">
				<div id="pppp2" class="btn-head-play">Ranking</div>
			</div>
		</div>
		<div class="mouse">
	...
	<section class="ftco-section ftco-agent goto-here">
		<!-- 안에 내용 그려주는 가장 큰 틀 -->
		<div class="container">
			<div class="row">
				<iframe
					src="http://localhost:8088/record"></iframe>
			</div>
		</div>
	</section>
