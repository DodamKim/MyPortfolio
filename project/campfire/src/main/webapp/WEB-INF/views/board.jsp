...
<script type="text/javascript">
	...
	$(function() {
		...
		var l_mno = localStorage.getItem('mno');
		...
		$.getJSON('/getCnt', function(data) {
			...
			for (i = startPage; i <= endPage; i++) {
				$('#btnPageSpan').append(
						'<a href="#" class="nowPage btnPage">' + i
								+ '</a>&nbsp;&nbsp;')
			}
	...
	<div id="contentarea">
		<div id="innercontentarea-search" class="pt-5">
			<form>
				...
				<input type='hidden' id='sc' name='sc' value='${search }'>
				<input
					type='hidden' id='key' name='key' value='${keyword }'> 
					<span
					id="selSP"> 
		...
		<div id="innercontentarea-new">
			<button type="button" id="btnNew" class="btn btn-new">새글쓰기</button>
		</div>
	</div>
