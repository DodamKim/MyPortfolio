				...
				.click(
						function(e) {
							...
							var iframe = $('<iframe></iframe>')
									.attr(
											'src',
											'https://codesandbox.io/embed/1103-finaladd-edit-map-c0n1t?fontsize=14&hidenavigation=1&theme=dark&view=preview');
							$('#frame').append(iframe);

							$.getJSON('/insertTempPlay', function(r) {
								console.log('플레이수 증가 +' + r)
							})
...
<body>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="ppp1">
				<div id="ppp2" class="btn-head-play">토끼의 모험</div>
			</div>
		</div>
		<div class="mouse">
	...
	<section class="ftco-section goto-here" style="margin-bottom: 0">
		<div class="container">
			<div class="row justify-content-center ftco-animate mb-5">
				<div class="col-md-12 heading-section text-center">
					<div>
						<span class="subheading">게임 하기</span>
						<h2 class="mb-2">PRESS THE PLAY BUTTON</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row" style="width: 800px; height: 695px">
				<div id="cover_top" class="cover_top"></div>
				<div id="frame">
					<img id="img">
				</div>
				<div id="cover_bottom"></div>
				<div class="play">P L A Y</div>
				<br>
				<div class="quit">Q U I T</div>
			</div>
		</div>
	</section>
	...
	<section class="ftco-section">
		<div class="container">
			<iframe id="chat" src="http://172.20.10.4:3001"></iframe>
		</div>
	</section>
