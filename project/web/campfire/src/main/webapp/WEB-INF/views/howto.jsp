...
.howto-active, .howto-step-dot:hover {
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<div id='myPage'>
							<button id='myinfo' class="button" style="width: auto;">내정보</button>
							<div id="id01" class="modal">
								<form class="modal-content animate" action="/action_page.php"
									method="post">
									<div class="imgcontainer">
                                        <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
                                        <img src="mimg/${img}" alt="Avatar" class="avatar"><br>
										<input type="file" class="input uplordImg" name="uplordImg">
									</div>

									<div class="container">
                                        <label for="uname"><b>Nickname</b></label>
                                        <input class="input" type="text" value="${nickname }" name="uname" required>
									</div>

									<div class="container" style="background-color: #f1f1f1">
										<button type="button" id="updateProfile" class="button updateProfile">저장</button>
										<button type="button" onclick="document.getElementById('id01').style.display='none'" class="button cancelbtn">취소</button>
									</div>
								</form>
							</div>
						</div>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="ppp1">
				<div id="ppp2" class="btn-head-play">How to</div>
			</div>
		</div>
		<div class="mouse">
	...
	<section class="ftco-section ftco-no-pb goto-here">
		<div class="container">
            ...
            <i class="fas fa-angle-double-left howto-step-left" onclick="plusStep(-1)"></i>

            <div class="howto-step-slides">
                <img class="howto-step-img" src="images/tiptip1-0.gif">
                <div class="howto-step-content">
                    <h2 class="howto-step-title">How to, Step one.</h2>
                    <p><i class="fas fa-arrow-left"></i>&nbsp;&nbsp;,&nbsp;&nbsp;A&nbsp;&nbsp;:&nbsp;&nbsp;왼쪽으로 이동</p>
                    <p><i class="fas fa-arrow-right"></i>&nbsp;&nbsp;,&nbsp;&nbsp;D&nbsp;&nbsp;:&nbsp;&nbsp;오른쪽으로 이동</p>
                    <p><i class="fas fa-arrow-up"></i>&nbsp;&nbsp;,&nbsp;&nbsp;W&nbsp;&nbsp;:&nbsp;&nbsp;점프</p>                    
                </div>
            </div>

            <div class="howto-step-slides">
                <img class="howto-step-img" src="images/tiptip1-1.gif">
                <div class="howto-step-content">
                    <h2 class="howto-step-title">How to, Step two.</h2>
                    <p>우리의 토끼를 방해하는 적이 있어요!</p>
                    <p>연약한 토끼는 적과 닿으면 죽어요..</p>
                </div>
            </div>

            <div class="howto-step-slides">
                <img class="howto-step-img" src="images/tiptip1-2.gif">
                <div class="howto-step-content">
                    <h2 class="howto-step-title">How to, Step three.</h2>
                    <p>우리의 토끼를 방해하는 슬라임은 밟아버렷!</p>
                    <p>천천히 움직이는 슬라임, 빨빨거리는 멍뭉이, 날아다니는 로봇, 그리고 마자용도 있어요!</p>
                </div>
            </div>

            <div class="howto-step-slides">
                <img class="howto-step-img" src="images/tiptip1-3.gif">
                <div class="howto-step-content">
                    <h2 class="howto-step-title">How to, Step four.</h2>
                    <p>나무장작이 보이면 먹어야해요 :)</p>
                    <p>잘 살펴보면 뛰어서 갈 수 있는 곳이 있어요.</p>
                    <p>쩜프! 쩜-프! 못도 밟으면 안돼애!</p>
                </div>
            </div>

            <div class="howto-step-slides">
                <img class="howto-step-img" src="images/tiptip1-4.gif">
                <div class="howto-step-content">
                    <h2 class="howto-step-title">How to, Step five.</h2>
                    <p>너무 멀어서 뛰기 힘든 곳은 box를 만들 수 있어요.</p>
                    <p>원하는 곳에서 클릭해서, 만들어진 box를 밟고 지나가요.</p>
                    <p>하지만 막 만들면 안돼애~ 갯수가 정해져 있답니다!</p>
                    <p>마지막 장작까지 먹으면,</p>
                    <p>다음 스테이지로 갈 수 있는 횃불이 나타나요 :)</p>
                </div>
            </div>

            <i class="fas fa-angle-double-right howto-step-right" onclick="plusStep(1)"></i>

            <div class="howto-step-dotGR">
                <span class="howto-step-dot" onclick="currentStep(1)"></span>
                <span class="howto-step-dot" onclick="currentStep(2)"></span>
                <span class="howto-step-dot" onclick="currentStep(3)"></span>
                <span class="howto-step-dot" onclick="currentStep(4)"></span>
                <span class="howto-step-dot" onclick="currentStep(5)"></span>
            </div>
		</div>
	</section>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    ...
    var showStep = function(n){
        var i;
        var steps = document.getElementsByClassName("howto-step-slides");
        var dots = document.getElementsByClassName("howto-step-dot");
        if (n > steps.length) {
            stepIdx = 1;
        }    
        if (n < 1) {
        ...
        for (i = 0; i < dots.length; i++) {
            dots[i].className = dots[i].className.replace(" howto-active", "");
        }

        steps[stepIdx-1].style.display = "inline-block";  
        dots[stepIdx-1].className += " howto-active";
    }
