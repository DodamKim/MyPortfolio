...
<html lang="en">
<head>
<title>캠프파이어 코리아 - contact us</title>
<meta charset="utf-8">
<meta name="viewport"
...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9797dc90c57374948488d51150870dbc"></script>
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9797dc90c57374948488d51150870dbc"></script>
...
window.onload = function(){
	...
	var options = {
		center: new kakao.maps.LatLng(37.552309, 126.937773),
		level: 3
	};

	var map = new kakao.maps.Map(container, options);

	var markerPosition  = new kakao.maps.LatLng(37.552309, 126.937773); 
...
$(function(){
	...
	$("#sendMail").click(function(){
		...
		alert(data)
		$.ajax({url:'/send', data:data, success:function(r){
			if(r == 1){
				alert('이메일이 접수되었습니다.')
			}
		}})
...
<body>
	...
	<div class="hero-wrap ftco-degree-bg"
		...
		<div class="container">
			<div id="ppp1">
				<div id="ppp2" class="btn-head-play">Contact us</div>
			</div>
		</div>
		<div class="mouse">
				...
				<div class="col-md-8">
					<div class="row mb-5">
						<div class="col-md-4 text-center py-4">
							...
							<p>
								<span>Address:</span> 서울특별시 마포구 백범로 23 <br>구프라자 3층
							</p>
						</div>
						<div class="col-md-4 text-center border-height py-4">
							...
							<p>
								<span>Phone:</span> <a href="tel://1234567920">+ 8610 2355
									4598</a>
							</p>
						</div>
						<div class="col-md-4 text-center py-4">
							...
							<p>
								<span>Email:</span> <a href="mailto:info@yoursite.com">campfire@info.co.kr</a>
							</p>
						</div>
					</div>
				</div>
			...
			<div class="row block-9 justify-content-center mb-5">
				<div class="col-md-8 mb-md-5">
					<h2 class="text-center">
						문의사항이나 건의사항이 있으시다면, <br> Campfire에 이메일을 보내주세요!
					</h2>
					<form id='F' class="bg-light p-5 contact-form">
						...
						<div class="form-group">
							<textarea cols="30" rows="7" id='text' name='text' class="form-control"
								placeholder="Message"></textarea>
						</div>
						<div class="form-group">
							<input type="submit" id='sendMail' value="Send Message"
						...
						<div class="block-23 mb-3">
							<ul>
								<li><span class="icon icon-map-marker"></span><span
									class="text">서울특별시 마포구 백범로 23 구프라자 3층</span></li>
								<li><a href="#"><span class="icon icon-phone"></span><span
										class="text">+ 8610 2355 4598</span></a></li>
								<li><a href="#"><span class="icon icon-envelope pr-4"></span><span
										class="text">campfire@info.co.kr</span></a></li>
							</ul>
						</div>
					</div>
				</div>
